...
return [
    'welcome'                => 'Welcome to the HYBRIDOITC Compass. Every good app needs a compass to point them in the right direction.
    ...
    'links'         => [
        ...
        'voyager_homepage'      => 'HYBRIDOITC Homepage',
        'voyager_hooks'         => 'HYBRIDOITC Hooks',
    ],
    
    'commands'      => [
        'title'                 => 'Commands',
        'text'                  => 'Run Artisan Commands from HYBRIDOITC.',
    ...
    'resources'     => [
        'title'                 => 'Resources',
        'text'                  => 'HYBRIDOITC resources to help you find things quicker.',
    ...
    'fonts'         => [
        'title'                 => 'Fonts',
        'font_class'            => 'HYBRIDOITC Fonts Class Mapping',
        'font_character'        => 'HYBRIDOITC Fonts Character Mapping',
    ],
];
